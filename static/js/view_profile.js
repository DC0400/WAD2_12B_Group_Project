...
async function fetchTopTracks(token) {
    let url = new URL("https://api.spotify.com/v1/");
    url.searchParams.append('', profile_username);
    url.searchParams.append('', "/top/tracks?time_range=short_term&limit=10");
...
async function fetchMinutes(token){
    let url = new URL("https://api.spotify.com/v1/")
    url.searchParams.append('', profile_username)
    url.searchParams.append('', "/player/recently-played?limit=50")
